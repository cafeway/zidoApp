...
<head>
  ...
  <title>Powermax Fx and Crypto</title>
  <!-- General CSS Files -->
              ...
              <div class="dropdown-list-content dropdown-list-icons">
                <a href="#" class="dropdown-item dropdown-item-unread"> <span
                    ...
                    clean it! <span class="time">17 Hours Ago</span>
												...
												fa-bell"></i>
                  </span> <span class="dropdown-item-desc"> Welcome to Powermax Traders
        ...
        <aside id="sidebar-wrapper">
          <div class="sidebar-brand">
            <a href="index.html"> <img alt="image" src="assets/img/logo.png" class="header-logo" /> <span
                class="logo-name">Powermax</span>
            </a>
          </div>
          <ul class="sidebar-menu">
            <li class="menu-header">UserPanel</li>
            <li class="dropdown active">
              <a href="{{ route('home') }}" class="nav-link"><i data-feather="home"></i><span>Dashboard</span></a>
            </li>
            <li class="dropdown">
            ...
            <li class="dropdown">
              ...
              <ul class="dropdown-menu">
                <li><a class="nav-link" href="alert.html">Facebook</a></li>
                <li><a class="nav-link" href="badge.html">Twitter</a></li>
                <li><a class="nav-link" href="breadcrumb.html">Whatsapp</a></li>
                <li><a class="nav-link" href="buttons.html">Instagram</a></li>
              </ul>
            </li>
            <li class="dropdown">
            ...
            <li class="dropdown">
              <a href="#"><i data-feather="youtube"></i><span>ads</span></a>
              {{-- <ul class="dropdown-menu">
            ...
            <li class="dropdown">
              <a href="#"><i data-feather="credit-card"></i><span>Withdraw</span></a>
            ...
            {{-- <li><a class="nav-link" href="vector-map.html"><i data-feather="map-pin"></i><span>Vector
                  Map</span></a></li> --}}
            <li class="menu-header">Reset/Change Password</li>
            <li class="dropdown">
              <a href="#" class="menu-toggle nav-link has-dropdown"><i
                  data-feather="user-check"></i><span>change</span></a>
              <ul class="dropdown-menu">
                <li><a href="{{ route('reset') }}">Forgot Password</a></li>
                <li><a href="{{ route('change') }}">Reset Password</a></li>
              </ul>
            </li>
            <li class="menu-header">GetHelp</li>
            <li class="dropdown">
              <a href="#" class="menu-toggle nav-link has-dropdown"><i
                  data-feather="send"></i><span>Contact Us</span></a>
              <ul class="dropdown-menu">
                <li><a href="{{ route('reset') }}">Whatsapp</a></li>
                <li><a href="{{ route('change') }}">Telegram</a></li>
                <li><a href="{{ route('change') }}">learn How it works</a></li>
                {{-- <li><a href="{{ route('change') }}">Telegram</a></li> --}}
              </ul>
            </li>
            {{-- <li class="dropdown">
