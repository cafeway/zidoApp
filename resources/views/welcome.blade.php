...
<body>
                ...
                <div class="card-statistic-4">
                  <div class="align-items-center justify-content-between">
                    <div class="row ">
                      ...
                      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pl-0">
                        <div class="banner-img">
                          <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSqHn_y9P_ax60WXhQNpYu-ZJbj4sjndfZZJQ&usqp=CAU" alt="">
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div class="card-statistic-4">
                  <div class="align-items-center justify-content-between">
                    <div class="row ">
                      ...
                      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pl-0">
                        <div class="banner-img">
                          <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRbqfHKs3bzTcsKJ52im19PvcE2G58EI1MhkA&usqp=CAU" alt="">
                        </div>
                      </div>
                    </div>
                  </div>
  ...
  <!-- JS Libraies -->
  <script src={{ URL::asset('bundles/apexcharts/apexcharts.min.js') }}></script>
